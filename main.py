...
print("\n================== Table Cipher ==================")
enc_table = table_cipher_encrypt(original_text)
dec_table = table_cipher_decrypt(enc_table)
print("Encrypted:")
print(enc_table)
print("\nDecrypted:", dec_table)